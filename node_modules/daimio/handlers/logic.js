    ...
    methods: {
      ...
      'if': {
        ...
        fun: function(value, then, _else, _with, prior_starter, process) {
          var branch = D.ETC.isFalse(value) ? _else : then
      ...
      'is': {
        ...
        fun: function(value, _in, like) {
          if(!D.isNice(like)) {
            ...
            if(!_.isArray(value)) return D.onerror("Requires 'in', 'like', or a value list")
      ...
      not: {
        ...
        fun: function(value) {
          return D.ETC.isFalse(value) ? true : false

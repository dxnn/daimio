...
DAML.Stacker.prototype.next = function(cb) {
  ...
  if(this.current_index > this.size) return false  // TODO: self-destruct, somehow? this stacker is D-U-N.
  ...
  var funitem = this.fing.stack[this.current_index]
  this.current_index++
...
DAML.Stacker.prototype.run = function() {
  ...
  while(this.current_index <= this.size) {
    this.next(my_cb)
  }
  return true
} 
...
// stacker needs last_value, current_index, next function... maybe that's it

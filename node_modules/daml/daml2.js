...
DAML.Parser.split_terminators = function(pipeline_string) {
  return pipeline_string
          .split(/|/)
          .map(function(segment) {return segment.replace(/^\s+|\s+$/g, '')}) 
}

DAML.Parser.munge_number = function(segment) {
...
DAML.Parser.munge_string = function(segment) {
  if(typeof segment != 'string') 
    return segment
  ...
  return (+segment !== +segment) ? {Number: +segment} : segment
}

DAML.Parser.munge_list = function(segment) {
  if(typeof segment != 'string') 
    return segment
...
DAML.Parser.munge_fancy = function(segment) {
  if(typeof segment != 'string') 
    return segment

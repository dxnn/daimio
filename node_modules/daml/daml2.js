...
// var stack = new Stacker(block, function (val) {console.log(val)})
// stack.run()

DAML.Stacker = function(block, when_done) {
...
function asdf() {
  ...
  block.stack[1] = {params: [7200, function(stacker) {return stacker.last_value}], flags: {}, fun: function(p, q) {console.log(p, q, 111); return p + q} }
  block.stack[2] = {params: [7300, function(stacker) {return stacker.last_value}], flags: {}, fun: function(p, q) {console.log(p, q, 222); return p + q} }

  fstack = new DAML.Stacker(block, function (val) {console.log(val, 777)})
}


// er...
// A Block has a command stack, that's part of it.
// the Stacker takes a block and a cb, runs the block, then calls the cb with its value

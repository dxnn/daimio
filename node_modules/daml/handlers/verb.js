  ...
  verb: {
    ...
    methods: {
      ...
      add: {
        ...
        fun: function(type, from, to, strength, data) {
          var verb = {
            type: type,
            data: data,
            from: from,
      ...
      set_strength: {
        ...
        params: [
          ...
          {
            key: 'value',
            desc: 'The value of the new strength',
            type: 'number',
            required: true,
          },
        ],
        fun: function(id, value) {
          DAML.db.collection('verbs', function(err, c) {
            c.update({_id: new DAML.mongo.ObjectID(id)}, {$set: {strength: value}}, {}, function(err, result) {});
          });
        },
      },

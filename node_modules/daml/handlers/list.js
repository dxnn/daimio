    ...
    methods: {
      ...
      map: {
        ...
        fun: function(data, block, _with, prior_starter, process) {
          ...
          */
          ...
          return DAML.dataTrampoline(data, processfun, DAML.list_set, prior_starter, DAML.scrub_list)
        },
      },
      ...
      reduce: {
        ...
        fun: function(data, block, _with, prior_starter, process) {
          ...
          return DAML.dataTrampoline(data, processfun, joinerfun, prior_starter)
        },
      },
      ...
      each: {
        ...
        fun: function(data, block, _with, prior_starter, process) {
          ...
          return DAML.dataTrampoline(data, processfun, DAML.string_concat, prior_starter)
      ...
      from_json: {
        ...
        fun: function(data) {
          if(!data) return []
          // THINK: use DAML.json_parse instead or something?
      ...
      pair: {
        ...
        fun: function(data) {
          ...
          if(data.length < 2) {            
            return DAML.setError('The data parameter must contain at least two elements') || {}
          }
      ...
      intersect: {
        ...
        fun: function(data, also) {
          ...
          else values = DAML.toArray(data)
          
          var number_of_arrays = values.length
          
          values.forEach(function(list, index) {
            list = DAML.toArray(list)
            list.forEach(function(value) {
              var key = typeof value == 'object' ? DAML.stringify(value) : value
      ...
      peek: {
        ...
        fun: function(data, path) {
          ...
          if(typeof data != 'object')
            data = DAML.toArray(data)
          
          return DAML.peek(data, path)
          
          return DAML.resolve_path(path, data)
        },
      },
      ...
      poke: {
        ...
        fun: function(data, path, value) {
          ...
          return DAML.resolve_path_and_mod(path, data, function(x) {return value})
        },
      },
          ...
          for(var i=0, l=values.length; i < l; i++) {
            ...
            for(var key in value) {
              ...
              if(typeof temp == 'number' || typeof temp == 'string') { // scalar
                ...
                hash[key] = DAML.commands.list.methods.union.fun(stack)
              }
            }
          }
      ...
      rekey: {
        ...
        fun: function(data, by, _with, prior_starter, process) {
          ...
          if(typeof by == 'function') {
            ...
            processfun = function(item, prior_starter) {
              return DAML.resolve_path(by, item)
            }
          } 
          else {
          ...
          return DAML.dataTrampoline(data, processfun, DAML.list_push, prior_starter, finalfun)
        },
      },
        ...
        fun: function(data, block, prior_starter, process) {
          ...
          */
          ...
          var joinerfun = function(total, value) {
            ...
            if(!DAML.isNice(value)) return total
            total.push(value)
            return total
          }
      ...
      first: {
        ...
        fun: function(data, block, prior_starter, process) {
          ...
          return DAML.dataTrampoline(data, processfun, DAML.noop, prior_starter, finalfun)
        },
      },
      ...
      unique: {
        ...
        fun: function(data) {
          ...
          for(var i = 0, len = keys.length; i < len; i++) {
            var key = keys[i]
              , value = data[key]
              , valuekey = typeof value == 'object' ? DAML.stringify(value) : value
      ...
      index: {
        ...
        fun: function(data, value) {
          ...
          value = DAML.toArray(value).map(JSON.stringify) // for matching nested structures

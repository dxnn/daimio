    ...
    methods: {
      ...
      sort: {
        ...
        fun: function(data, by, prior_starter) {          
          ...
          return DAML.dataTrampoline(data, processfun, DAML.list_concat, prior_starter, finalfun)
      ...
      filter: {
        ...
        fun: function(data, block, prior_starter) {
          ...
          return DAML.dataTrampoline(data, processfun, DAML.list_concat, prior_starter)
        },
      },

    ...
    methods: {
      ...
      union: {
        ...
        fun: function(value, also) {
          ...
          if(also) values = [also, value]
          else values = _.toArray(value)
          
          if(_.isArray(values[0])) return _.union.apply(this, values)
          ...
          for(var i=0, l=values.length; i < l; i++) {
            ...
            for(var key in value) {
              ...
              if(_.isNumber(temp) || _.isString(temp)) { // scalar
                hash[key] = temp
              } else if(DAML.isFing(temp)) { // fing
                hash[key] = temp
              } else { // list
      ...
      range: {
        ...
        fun: function(length, start, step) {
          ...
          if(length <= 0) return DAML.onerror('The step must be positive');

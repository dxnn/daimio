  ...
  list: {
    ...
    methods: {
      ...
      reduce: {
        ...
        fun: function(data, block, prior_starter, process) {
          ...
          var processfun = function(item, prior_starter) {
            ...
            scope["value"] = item
            scope["total"] = total
            return block(function(value) {prior_starter(value)}, scope, process.space)
          }
      ...
      filter: {
        ...
        fun: function(data, block, prior_starter) {
          var scope = {}
          ...
          var processfun = function(item, tramp_prior_starter) {
            ...
            scope["*in"] = item
            var bool = block(function(value) {my_tramp_prior_starter(value)}, scope) 

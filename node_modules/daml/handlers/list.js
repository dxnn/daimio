    ...
    methods: {
      ...
      map: {
        ...
        fun: function(data, block, prior_starter, process) {
          ...
          */
          ...
          //   if(!DAML.isNice(total)) return []
          //   value = DAML.isNice(value) ? value : [""]
          //   return DAML.list_concat(total, value)
          // }
          
          return DAML.dataTrampoline(data, processfun, DAML.list_push, prior_starter)
        ...
        params: [
          {
            ...
            type: 'array' // array of arrays, technically
          }
        ],
        fun: function(values) {
          var hash = {}
            , result = []
            , number_of_arrays = values.length
      ...
      rekey: {
        ...
        fun: function(value, path, stack) {
          ...
          if(!path) return _.toArray(value)
          
          for(var index in value) {
            new_index = DAML.resolve_path(path, value[index])
            
            if(!stack) {
              new_data[new_index] = value[index]
            } 
            else {
              if(!new_data[new_index]) new_data[new_index] = []
              new_data[new_index].push(value[index])
            }
          }
      ...
      sort: {
        ...
        fun: function(data, by, prior_starter) { 
          ...
          if(typeof by == 'function') {
            processfun = function(item, prior_starter) {
              var scope = {}
              scope["*in"] = item
              return by(function(value) {prior_starter(value)}, scope)
            }
          }
          else if(by) {
            processfun = function(item, prior_starter) {
      ...
      range: {
        ...
        fun: function(length, start, step) {
          ...
          if(length <= 0) 
            return DAML.onerror('The length must be positive');

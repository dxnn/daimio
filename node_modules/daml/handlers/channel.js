        ...
        fun: function(from, to, prior_starter, process) {
          ...
          var make_me_a_gateway = function(maybe_gateway) {
            ...
            if(DAML.GATEWAYS[maybe_gateway])
              return DAML.GATEWAYS[maybe_gateway]
            ...
            return DAML.add_gateway(null, 'spaceblock', {block: maybe_gateway, space: process.space}).name
          }
          
          from.map(make_me_a_gateway)
          
          to.map(make_me_a_gateway)
          
          // herp derp merp berp
          
          var channel_name = 'channel:' + Math.random()
            , channel = DAML.models.channel.methods.add.fun(channel_name)
          
          from.forEach(function(gateway_name) {
            DAML.models.channel.methods['attach-to-start'].fun(channel_name, gateway_name)
          })
          
          to.forEach(function(gateway_name) {
            DAML.models.channel.methods['attach-to-end'].fun(channel_name, gateway_name)
          })

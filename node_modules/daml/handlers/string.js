    ...
    methods: {
      ...
      join: {
        ...
        fun: function(value, on) {
          ...
          for(var i=0, l=value.length; i < l; i++) {
            ...
            if(on && i != l - 1) 
              good_string += on
              // good_string += DAML.stringify(DAML.defunctionize(on)) // NOTE: defunc runs the blocks before stringify toString()s them, so we need both (even though stringify also defuncs).
          }
          return good_string
      ...
      transform: {
        ...
        fun: function(value, from, to, prior_starter) {
          ...
          return DAML.dataTrampoline(matches, processfun, DAML.list_push, prior_starter, finalfun)

    ...
    methods: {
      ...
      join: {
        ...
        fun: function(value, on) {
          ...
          for(var i=0, l=value.length; i < l; i++) {
            ...
            if(on && i != l - 1) good_string += DAML.stringify(DAML.defunctionize(on)); // NOTE: defunc runs the fings before stringify toString()s them, so we need both (even though stringify also defuncs).
          }
          return good_string;
      ...
      slice: {
        ...
        fun: function(value, start, end) {
          // THINK: how can we use a single slice/concat/etc command for both strings and lists?

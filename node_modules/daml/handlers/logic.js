    ...
    methods: {
      ...
      'is': {
        ...
        fun: function(value, _in, like) {
          if(!DAML.isNice(like)) {
            if(!DAML.isNice(_in)) return DAML.onerror("You must supply either the 'in' or the 'like' parameter");
            return _in.indexOf(value) !== -1;
          }
      ...
      or: {
        desc: "If any values is true, return true (runs all incoming templates, no short-circuiting)",
        params: [
          {
            key: 'value',
            desc: 'A set of values to check for truthiness',
            type: 'list',
            required: true,
          },
        ],

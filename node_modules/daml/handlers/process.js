    ...
    methods: {
      ...
      wait: {
        ...
        fun: function(_for, then, callback) {
          if(DAML.isNice(_for)) { // TODO: you don't need this, right?
            setTimeout(function() {callback(then)}, _for) // make this include the until stuff too
            // setTimeout(function() {then(callback)}, _for) // make this include the until stuff too
          }

    ...
    methods: {
      ...
      add: {
        ...
        fun: function(value, to) {
          return DAML.ETC.solver(value, to, function(a, b) {return a + b;});
        },
      },
      ...
      subtract: {
        ...
        fun: function(value, from) {
          return DAML.ETC.solver(from, value, function(a, b) {return a - b;});
        },
      },
      ...
      divide: {
        ...
        fun: function(value, to) {
          return DAML.ETC.solver(value, to, function(a, b) {
            if(!b) DAML.setError('Division by zero is a crime against nature');
            return a / b;
          });
        },
      },
      ...
      increment: {
        ...
        params: [
          {
            key: 'value',
            desc: "A value to succeed",
            type: "number",
            required: true
          },
        ],
        fun: function(value) {
          return DAML.ETC.toNumeric(value) + 1;
        },
      },

      decrement: {
        desc: "The anti-successor",
        help: [
      ...
      mod: {
        ...
        fun: function(value, by) {
          return DAML.ETC.solver(value, by, function(a, b) {return a % b;});
        },
      },
      ...
      round: {
        ...
        fun: function(value, to) {
          ...
          var power = Math.ceil(Math.pow(10, to));
...
DAML.ETC.solver = function(value, to, fun) {
  ...
  if(arrays == 2) return DAML.ETC.doubleArray(value, to, fun);
  if(arrays == 1) return DAML.ETC.singleArray(value, to, fun);
  if(arrays == 0) return DAML.ETC.naryanArray(value, to, fun);
};

DAML.ETC.doubleArray = function(value, to, fun) {
  _.each(value, function(val, key) {
    value[key] = fun(DAML.ETC.toNumeric(val), DAML.ETC.toNumeric(to[key]));
  });
  return value;
};

DAML.ETC.singleArray = function(value, to, fun) {
  ...
  if(DAML.ETC.isNumeric(to)) {
    _.each(value, function(val, key) {
      value[key] = fun(DAML.ETC.toNumeric(val), DAML.ETC.toNumeric(to));
    });
    return value;
  }
...
DAML.ETC.naryanArray = function(value, to, fun) {
  if(!DAML.ETC.isNumeric(value)) return DAML.setError("That is not a numeric value");
  if(!DAML.ETC.isNumeric(to)) return DAML.ETC.toNumeric(value);

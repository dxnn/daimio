...
DAML.ETC.Math = {};
var DMath = DAML.ETC.Math;

DMath.solver = function(value, to, fun) {
  ...
  if(arrays == 2) return DMath.doubleArray(value, to, fun);
  if(arrays == 1) return DMath.singleArray(value, to, fun);
  if(arrays == 0) return DMath.naryanArray(value, to, fun);
};

DMath.doubleArray = function(value, to, fun) {
...
DMath.singleArray = function(value, to, fun) {
...
DMath.naryanArray = function(value, to, fun) {

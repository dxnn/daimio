      ...
      init: {
        ...
        fun: function() {
          ...
          $('#commander').keyup(function(e) {
            ...
            //     // obj = DAML.models.history.methods.get_prev(self.search, self.current);
            //     if(obj && obj.string) {
            ...
            //     // obj = DAML.models.history.methods.get_next(self.search, self.current);
            //     if(obj && obj.string) {
            //       $('#commander').val(obj.string);
            //       self.current = obj.current;
            //     }
            ...
            //           return _.select(Object.keys(DAML.models || []), function(value) {return regex.test(value);});
            //         }(words[0]),
            //       };
            //     } 
            // 

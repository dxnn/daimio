...
DAML.import_gateway_type('dom-get-value', {
  ...
  addListener: function(callback) {
    ...
    if(!element) 
      return DAML.setError('That dom thing ("' + this.thing + '") is not present')
...
DAML.import_gateway_type('svg-move', {
  sendMessage: function(value, prior_starter) {
    var element = document.getElementById(value.thing)
  ...
  addListener: function(callback) {
    // THINK: this only applies in SAR mode or something, right?
  }
})

DAML.import_gateway_type('svg-rotate', {
  sendMessage: function(value, prior_starter) {
    var element = document.getElementById(value.thing)
...
DAML.import_gateway_type('svg-addline', {
  sendMessage: function(value, prior_starter) {
    var element = document.getElementById(value.thing)
...
DAML.Space.prototype.REAL_execute = function(block, scope, prior_starter, listeners) {
  ...
  // TODO: override the prior_starter here -- THIS function is the prior starter now. (basically, remember to cleanup after and fire the listeners.)

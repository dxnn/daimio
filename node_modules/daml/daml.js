...
/*
  ...
  DAML.ASPACES is for abstract spaces, ie the spacial data that is imported/exported.
...
DAML.Space = function(id, dialect, state, ports, stations, parent) {
  ...
  this.id = id // TODO: validate id...?
  this.dialect = dialect // TODO: validate dialect?
  this.parent = parent || false // false is outer
  this.state = state || {}

  this.stations = []
  stations = stations || []
  stations.forEach(this.add_station)
  // stations = stations.map(function(block_id) { return DAML.ABLOCKS[block_id] })

  this.ports = []
  ports = ports || []
  ports.filter(function(port) { return port.space == id })

...
DAML.add_type('string', function(value) {
  ...
  // TODO: DAML.block_ref_to_string(value)
...
DAML.run = function(daml, callback, space) {
  ...
  space.execute(DAML.Parser.string_to_block_segment(daml), callback)
...
DAML.Process.prototype.run = function() {
  ...
  while(this.block.segments[this.current]) { // THINK: this feels unnecessary, and we don't want to have this fail here...
...
DAML.Process.prototype.next = function(callback) {
  ...
  // var value = type.execute(segment, inputs, this.space.dialect, callback)
  // callback(value)
  // varset[key] = value

...
DAML.Parser.wrap_in_empty_ABlock = function(body) {
  return new DAML.ABlock(false, body)
}
...
DAML.ABlock = function(head, body) {
  // soooooo... this assumes head is a bunch of segments OR body is a bunch of strings or ABlock refs. right. gotcha.
  ...
  if(body) {
    // ensure it's an array of strings and ABlock refs
    this.body = body
  }

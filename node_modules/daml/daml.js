...
// TODO: can inc and dec just be calls to add/subtract?
...
DAML.import_aliases({
  ...
  'divide': 'math divide value',
  'inc': 'math increment value',
  'dec': 'math decrement value',
  'mod': 'math mod by',
  'less': 'math less',
...
// DAML's type system is dynamic, weak, and latent, with implicit casting user-definable via type methods.
...
DAML.add_type('hash', function(value) {
  ...
  return typeof value == 'object' ? value : [value]; // TODO: this doesn't always return a proper JS object, which is likely very bad. Find a better way.
});
...
DAML.ETC.toNumeric = function(value) {
  ...
  return false; // THINK: why false instead of 0?
};

...
DAML.import_port_type = function(flavour, pflav) {
  ...
  if(typeof pflav.dock != 'function')
    pflav.enter = function(ship) {this.enter(ship)}
...
DAML.spaceseed_add = function(seed) {
  ...
  var good_port_props = ['space', 'station', 'name', 'flavour', 'typehint']
...
DAML.Port.prototype.pair = function(port) {
  this.pair = port
  port.pair = this
...
DAML.Port.prototype.enter = function(ship) {
  this.pair.exit(ship)
}

DAML.Port.prototype.exit = function(ship) {
...
DAML.Space = function(seed_id, parent) {
  ...
  this.ports = seed.ports.map(function(port) {return new DAML.Port(port, this)})
  
  // add all my children
  this.subspaces = seed.subspaces.map(function(seed_id) {return new DAML.Space(seed_id, this)})
  ...
  this.subspaces.forEach(function(subspace, subspace_index) {
    ...
    subspace.ports
      ...
      .forEach(function(port, port_index) {my_ports[index].pair(port)})
  })

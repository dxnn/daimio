...
// via https://github.com/kriskowal/es5-shim/blob/master/es5-shim.js
if (!Function.prototype.bind) {
  Function.prototype.bind = function bind(that) {
    ...
    // if(!typefun || !typefun.bind) {
    //   var key = pobj.type;
    //   console.log(Function.prototype.bind)
    //   console.log(Function.prototype.call)
    //   console.log(key);
    //   console.log(DAML.Vtypes[key]);
    //   console.log(JSON.stringify({x: DAML.Vtypes[key]()}));
    //   console.log('ok done');
    //   3 = x.y;
    //   
    // }

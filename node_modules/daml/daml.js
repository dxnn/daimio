...
DAML.import_gateway_type('dom-set-text', {
...
DAML.import_gateway_type('space-in', {
  sendMessage: function(value, prior_starter) {
    ...
    if(!prior_starter) {
      prior_starter = function() {} // prevents 'no callback sent' error
    }
    
    return space.deliver(value, prior_starter)
  },
  addListener: function(callback) {
...
DAML.import_gateway_type('spaceship', {
  sendMessage: function(value, prior_starter) {
    ...
    return space.execute(this.thing.block, scope, prior_starter, this.listeners)
  },
  addListener: function(callback) {
    // var space = this.thing.space
    // 
...
DAML.Space.prototype.REAL_execute = function(block, scope, prior_starter, listeners) {
  ...
  try {
    result = process.run()
    self.cleanup(process.pid, listeners)
  } catch(e) {
...
DAML.Space.prototype.cleanup = function(pid, listeners) {
  var value = this.scrub_process(pid)
  this.run_listeners(value, listeners)

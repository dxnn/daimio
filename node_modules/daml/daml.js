...
, execute: function(segment, inputs, dialect, prior_starter, process) {
    var handler = DAML.dialect_get_handler(dialect, segment.value.Handler)
      , method = DAML.dialect_get_method(dialect, segment.value.Handler, segment.value.Method)
...
DAML.dialect_get_handler = function(dialect, handler) {
  if(  handler 
    && dialect.models
    && dialect.models[handler]
    && dialect.models[handler]
  ) {
    return dialect.models[handler]
  }
...
DAML.dialect_get_method = function(dialect, handler, method) {
  if(  handler 
    ...
    && dialect.models
    && dialect.models[handler]
    && dialect.models[handler].methods
    && dialect.models[handler].methods[method]
  ) {
    return dialect.models[handler].methods[method]
  }
...
DAML.Space.prototype.dock = function(ship, station_id) {
  ...
  var scope = {"*in": ship} // TODO: find something better...
  this.execute(block, scope)
}
...
DAML.Process.prototype.next = function() {
  ...
  return type.execute(segment, inputs, this.space.seed.dialect, this.my_starter, this)
}
...
var seedid = DAML.spaceseed_add({dialect: DAML.DIALECTS.top, stations: [], subspaces: [], ports: [], routes: [], state: {}})

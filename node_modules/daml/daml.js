...
, execute: function(segment, inputs, dialect, callback) {
    ...
    return DAML.SPACES.top.execute(block, new_cb)
  }
}
...
DAML.Process.prototype.next = function(callback) {
  ...
  if(wiring[key]) {
    inputs = wiring[key].map(function(index) {return DAML.isNice(varset[index]) ? varset[index] : ""})
  }

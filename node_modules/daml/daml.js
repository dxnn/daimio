...
DAML.port_standard_enter = function(ship) {
  if(this.space && this.space.secret) { // for exec ports
    this.space.secret.result = ship
    ship = this.space.secret
  }
...
DAML.import_port_type('socket-connect', {
  dir: 'in',
  outside_add: function() {
    var self = this
    
    socket.on('connected', function (ship) {
...
DAML.import_port_type('socket-disconnect', {
  dir: 'in',
  outside_add: function() {
    var self = this
...
DAML.import_port_type('exec', {
  ...
  exit: function(ship) { 
    ...
    this.space.execute(DAML.Parser.string_to_block_segment(ship.code)) // TODO: ensure this is a block, not a string
  }
})
...
DAML.add_type('block', function(value) {
  if(DAML.isBlock(value)) {
    ...
    return function(prior_starter, scope, space) {
      ...
      // FIXME: THIS IS HORRIBLE DO IT IN THE SAME SPACE ARGH
      space = space || DAML.ExecutionSpace
...
, execute: function(segment, inputs, dialect, prior_starter, process) {
    ...
    var processfun = function(value) {
      return DAML.execute_then_stringify(value, {}, process.space)
    }
...
DAML.execute_then_stringify = function(value, prior_starter, space) {
  if(DAML.isBlock(value)) {
    return DAML.TYPES['block'](value)(prior_starter, {}, space)
  } else {
...
DAML.make_some_space = function(seedlikes) {
  ...
  for(var seedkey in seedlikes) {
    ...
    routes.map(function(route) {
      return newseed.routes.push([port_key_to_index[route[0]], port_key_to_index[route[1]]])
    })
